...
public class ServiceRequest {
    ...
    public ServiceRequest(String jurisdiction_id, String service_code, String service_name,
                          String api_key, Double lat, Double lang, String address_string,
                          String email, String device_id, String account_id, String first_name,
                          String last_name, String phone, String description, String summary,
                          String media_url, File media) {
        this.jurisdiction_id = jurisdiction_id;
        this.service_code = service_code;
    ...
    public static class Builder {
        ...
        public Builder setMedia(File media) {
            this.media = media;
            return this;
        }

        public ServiceRequest createServiceRequest() {
            return new ServiceRequest(jurisdiction_id, service_code, service_name, api_key, lat,
                    lang, address_string, email, device_id, account_id, first_name, last_name,
                    phone, description, summary, media_url, media);
        }
